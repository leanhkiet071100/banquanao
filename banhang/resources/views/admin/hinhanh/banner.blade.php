...
@section('sidebar')
    ...
    <div class="app-main__inner">
        ...
        @if ($logo != null)
            <form action="{{ route('admin.banner-sua', ['id' => $logo->id]) }}" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-12">
                                            ...
                                            <form method="post" enctype="multipart/form-data" data-url="">
                                                ...
                                                <div style="width: 100%; max-height: 220px; overflow: hidden;">
                                                    ...
                                                    <img style="width: 100%; cursor: pointer;" class="thumbnail"
                                                        ...
                                                        data-placement="bottom" src="{{URL(($logo->hinh_banner)??'admin/assets/images/add-image-icon.jpg')}}"
                                                        alt="Add Image">
